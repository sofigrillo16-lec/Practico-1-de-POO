...
class Alumno: #defino mi clase Alumno
    ...
    def imprimir(self):#metodo para mostrar la informacion del alumno
        print(f"Nombre: {self.nombre}, Nota: {self.nota}")

    def resultado(self):#metodo que me muestra el resultado de la nota del alumno y si ha aprobado o no
        if self.nota >= 7:
